...
CacheFlow408 是一个面向计算机考研 **408**（数据结构 / 操作系统 / 组成原理 / 计算机网络）的本地优先智能学习助手：基于个人知识库精准问答、回答可溯源、AI 随机出题即时判题，并自带一套量化评测体系——每一项检索策略选型都由 A/B 实验数据驱动。
...
| 对比 | 通用 ChatPDF / 纯 LLM | CacheFlow408 |
| --- | --- | --- |
